module Psd
  # Ported from https://raw.github.com/noaheverett/psd.js/master/src/psdheader.coffee
  # Thanks
  ...
  class PsdHeader
    ...
    def parse(packed)
      ...
      data = packed.unpack FORMAT_STR
      
      @mode = MODES[data.last.to_i]
      
      # # Add all of the header sections as properties of this object.
      # # @[section] = data.shift() for section in HEADER_SECTIONS
      HEADER_SECTIONS.each do |section|
        @data[section] = data.shift()
      end
